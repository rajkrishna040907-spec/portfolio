...
const logos = ["Raj Krishna", "SOFTWARE", "DEVELOPER"];
          ...
          >
            ...
            <div className="relative z-10 w-full h-full flex flex-col justify-between px-6 md:px-12 pt-24 pb-10">
              <h1
                ...
                className={`font-display uppercase leading-[0.85] tracking-[-0.03em] text-[22vw] md:text-[14vw] lg:text-[13rem] cursor-pointer hover:opacity-80 ${colors[colorMode]}`}
