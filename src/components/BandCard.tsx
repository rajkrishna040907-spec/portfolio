...
import cardsModel from "@/assets/cards.glb";
import cardBackground from "@/assets/new.jpeg";
import customPhoto from "@/assets/ID.png";

const GLTF_PATH = cardsModel;
const TEXTURE_PATH = cardBackground;
const PHOTO_PATH = customPhoto;
