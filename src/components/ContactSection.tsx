...
export default function ContactSection() {
    ...
    const myEmail = "rajkrishna040907@gmail.com";
    ...
    const handleFormSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (result.success) {
                alert("Message sent successfully directly to Raj Krishna!");
                setName("");
                setMessage("");
            } else {
    ...
    animate-[shine_4s_linear_infinite]"
                        ...
                        <div className="flex items-center justify-center lg:justify-start gap-5 mt-2">
                            ...
                            {/* linkedin */}
                            <a
                                href="https://www.linkedin.com/in/raj-krishna-9a09153a1?utm_source=share_via&utm_content=profile&utm_medium=member_android"
                                target="_blank"
                ...
                hover:shadow-[0_0_25px_rgba(255,255,255,0.12)]"
                    ...
                    group-hover:opacity-100 transition-opacity duration-300"
                            ...
                            {/* github */}
                            <a
                                href="https://github.com/rajkrishna040907-spec"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="group relative w-12 h-12 sm:w-14 sm:h-14 rounded-2xl
                border border-white/10
                ...
                cursor-pointer"
                    ...
                    group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                        ...
                        {showMailModal && (
                            <div className="mt-4 w-full max-w-sm mx-auto lg:mx-0
                                ...
                                <p className="text-xs uppercase tracking-[0.25em] text-white/40 font-mono">Email Address</p>

                                <div className="flex items-center gap-3">
                                    <span className="flex-1 text-sm text-white/80 font-mono bg-white/[0.04] border border-white/10 rounded-xl px-4 py-3 truncate select-all">
                                        {myEmail}
                                    </span>
                                    ...
                                    <button
                                        ...
                                        className={`px-4 py-3 rounded-xl text-xs font-bold uppercase tracking-wider
                                            transition-all duration-300 cursor-pointer shrink-0
                                            ${
                                                copied
                                                    ? "bg-green-500/20 border border-green-400/40 text-green-400"
                                                    : "bg-white/10 border border-white/15 text-white/80 hover:bg-white/15 hover:border-white/30 hover:text-white"
                                            }`}
                                    >
                                        {copied ? "Copied!" : "Copy"}
                                    </button>
                    ...
                    >
                        ...
                        >
                            ...
                            {/* extra glow */}
                            <div className="absolute -top-20 left-1/2 -translate-x-1/2 w-80 h-80 bg-white/5 blur-[100px] rounded-full opacity-40 group-hover:opacity-60 transition-opacity duration-700 pointer-events-none" />
...
<p className="text-center text-sm tracking-[0.22em] text-white/35">
  ...
  <span className="relative inline-block text-white/70">
    ...
    <span className="absolute left-1/2 -translate-x-1/2 -bottom-2">
      <span className="block h-px w-24 bg-gradient-to-r from-transparent via-white/25 to-transparent"></span>
    </span>
  </span>
</p>
                </div>
