...
<head>
    ...
    <title>Raj Krishna Resume</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        a.href = url;
        a.download = "Raj_Krishna_Resume.html";
      ...
      <div className="relative z-20 flex flex-col items-center justify-center min-h-screen gap-8">
        ...
        >
          ...
          >
            ...
            >
              <p>
                I'm currently a B.Tech 1st year student. My tech journey started 
                when I was in high school. It was the first time I introduced myself 
                to the tech field through a YouTube video.
              </p>

              <p>
                In 10th class, my curiosity led me to learn Java. That was the first 
                language that I learned on my own. That first "Hello World" code filled 
                me with excitement and joy.
              </p>
              ...
              <p>
                Something very powerful in tech is the blend of human imagination 
                power with Artificial Intelligence. There is no limit to this blend.
              </p>
              ...
              <p>
                After completing B.Tech, I want to innovate technologies and make 
                a meaningful contribution to the tech field.
              </p>
